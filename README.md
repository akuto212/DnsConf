...
5) (Optional) Provide `TARGET_IP` to **Environment secrets** if you want to use hosts file generation feature
6) Provide `DNS`,`REDIRECT` and `BLOCK` to **Environment variables**
